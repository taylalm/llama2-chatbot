...
with st.sidebar: 
    ...
    if 'REPLICATE_API_TOKEN' in st.secrets: 
        ...
        if not (replicate_api.startswith('r8_') and len(replicate_api) == 40): 
            ...
            st.success('Enter your prompt message!', icon = '👉')
    
    os.environ['REPLICATE_API_TOKEN'] = replicate_api

    #Adjustment of model parameters 
    st.subheader('Models and paramaters')
    ...
    temperature = st.sidebar.slider('temparature', min_value = 0.01, max_value = 5.0, value = 0.1, step = 0.01)
...
#Create LLM response generation function 
